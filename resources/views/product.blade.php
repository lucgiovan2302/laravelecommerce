                        ...
                        <div class="row no-gutters align-items-center ">
                            ...
                            <div class="col-lg-8 col-md-7">
                                <div class="slider-product-content">
                                    <h1 class="slider-title mb-10" data-animation="fadeInUp" data-delay="0.3s"><span>Iphone</span> 11 <span>designs</span></h1>
                ...
                <div class="single-slider">
                        <div class="slider-bg">
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="col-lg-8 col-md-7">
                                    <div class="slider-product-content">
                                        <h1 class="slider-title mb-10" data-animation="fadeInUp" data-delay="0.3s"><span>Test</span> Iphone <span>13</span></h1>
                                        <p class="mb-25" data-animation="fadeInUp" data-delay="0.9s">One day however a small line of blind text by the name of Lorem Ipsum <br> decided to leave for the far World of Grammar.</p>
                                        <a class="main-btn" href="#" data-animation="fadeInUp" data-delay="1.5s">Explore More <i class="lni-chevron-right"></i></a>
                                    </div> <!-- slider product content -->
                                </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="single-discount-product mt-30">
                        ...
                        <div class="product-content">
                            <h4 class="content-title mb-15">Iphone 11 reconditionné <br> est a prix plancher</h4>
                ...
                <div class="col-lg-6">
                    <div class="single-discount-product mt-30">
                        ...
                        <div class="product-content">
                            <h4 class="content-title mb-15">Mais plus <br>pour longtemps</h4>
                            <a href="#">Voir la collection <i class="lni-chevron-right"></i></a>
                        </div> <!-- product content -->
                    </div> <!-- single discount product -->
                </div>
            </div> <!-- row -->
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4">
                    <div class="collection-menu text-center mt-30">
                        <h4 class="collection-tilte">Notre collection</h4>
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a id="v-pills-decorative-tab" data-toggle="pill" href="#v-pills-decorative" role="tab" aria-controls="v-pills-decorative" aria-selected="false">Iphone 12</a>

                            <a id="v-pills-lighting-tab" data-toggle="pill" href="#v-pills-lighting" role="tab" aria-controls="v-pills-lighting" aria-selected="false">Iphone 13</a>

                            <a id="v-pills-outdoor-tab" data-toggle="pill" href="#v-pills-outdoor" role="tab" aria-controls="v-pills-outdoor" aria-selected="false">Iphone 13</a>

                            <a id="v-pills-storage-tab" data-toggle="pill" href="#v-pills-storage" role="tab" aria-controls="v-pills-storage" aria-selected="false">Iphone 12</a>
                        </div> <!-- nav -->
                    </div> <!-- collection menu -->
                </div>
                                ...
                                <div class="row product-items-active">
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            ...
                                            <div class="product-item-content text-center mt-30">
                                                <h5 class="product-title"><a href="#">Iphone 11</a></h5>
                                                <ul class="rating">
                                                    <li><i class="lni-star-filled"></i></li>
                                                    <li><i class="lni-star-filled"></i></li>
                                                    <li><i class="lni-star-filled"></i></li>
                                                ...
                                                <span class="discount-price">$1300.00</span>
                                            </div>
                                        </div> <!-- single product items -->
                                    </div>
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            ...
                                            <div class="product-item-content text-center mt-30">
                                                <h5 class="product-title"><a href="#">Iphone 12</a></h5>
                                                <ul class="rating">
                                                    <li><i class="lni-star-filled"></i></li>
                                                    <li><i class="lni-star-filled"></i></li>
                                                    <li><i class="lni-star-filled"></i></li>
                                                ...
                                                <span class="regular-price">$1500.00</span>
                                                <span class="discount-price">$1690.00</span>
                                            </div>
                                        </div> <!-- single product items -->
                                    </div>
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            ...
                                            <div class="product-item-content text-center mt-30">
                                                <h5 class="product-title"><a href="#">Iphone 13</a></h5>
                                                <ul class="rating">
                                                    <li><i class="lni-star-filled"></i></li>
                                                    <li><i class="lni-star-filled"></i></li>
                                                    <li><i class="lni-star-filled"></i></li>
                                    ...
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            ...
                                            <div class="product-item-content text-center mt-30">
                                                ...
                                                <span class="regular-price">$1300.00</span>
                                                <span class="discount-price">$1400.00</span>
                                            </div>
                                        </div> <!-- single product items -->
                                    </div>
                                    <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-title pb-30">
                        ...
                        <h3 class="title mb-15">Lorem ipsum sit amet</h3>
                ...
                <div class="col-lg-6">
                    <div class="services-left mt-45">
                        <div class="services">
                            ...
                            <a href="#" class="main-btn mt-30">Lire la suite <i class="lni-chevron-right"></i></a>
                        </div> <!-- services btn -->
                    </div> <!-- services left -->
                </div>
                <div class="col-lg-6">
                            ...
                            <div class="col-md-6 col-sm-8">
                                <div class="single-services text-center">
                                    ...
                                    <div class="services-content mt-20">
                                        <h5 class="title mb-10">Lorem ipsum</h5>
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="single-temp text-center mt-30">
                        ...
                        <div class="team-content mt-30">
                            <h4 class="title mb-10"><a href="#">Lucien ANDRIAMIHAJA</a></h4>
                            <span>FOUNDER</span>
    ...
    <section id="blog" class="blog-area pt-125">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center pb-25">
                        <h3 class="title mb-15">Lorem ipsum</h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog mt-30">
                        ...
                        <div class="blog-content">
                            <div class="content">
                                <h4 class="title"><a href="#">lorem ipsum sit amet dolor</a></h4>
                            ...
                            <div class="meta d-flex justify-content-between align-items-center">
                                <div class="meta-admin d-flex align-items-center">
                                    ...
                                    <div class="admin-title">
                                        <h6 class="title"><a href="#">L. ANDRIAMIHAJA</a></h6>
                                    </div>
                                </div>  <!-- meta admin -->
                                <div class="meta-icon">
                                    <ul>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="single-form form-group">
                                            <input type="text" name="name" placeholder="Entrer votre nom" data-error="Nom obligatoire." required="required">
                                            <div class="help-block with-errors"></div>
                                        </div> <!-- single form -->
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="single-form form-group">
                                            <input type="email" name="email" placeholder="Entrer votre email"  data-error="Email valide." required="required">
                                            <div class="help-block with-errors"></div>
                                        </div> <!-- single form -->
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="single-form form-group">
                                            <textarea name="message" placeholder="Votre message" data-error="Inserer des messages s'il vous plait." required="required"></textarea>
                                            <div class="help-block with-errors"></div>
                                        </div> <!-- single form -->
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="single-form form-group">
                                            <button class="main-btn" type="submit">Contactez-nous!</button>
                                        </div> <!-- single form -->
                                    </div>
                                </div> <!-- row -->
                            </form>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright text-center">
                            <p>Crafted by <a href="https://lucien-dev-andriamihaja.piroguedormorombe.mg/" rel="nofollow">Lucien Andriamihaja</a></p>
                        </div> <!-- copyright -->
                    </div>
                </div> <!-- row -->
